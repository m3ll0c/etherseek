...
class Retriever:
    @classmethod
    def urls_from_urlscan(cls, api_key: str) -> list:
        ...
        response = requests.get(
            ...
            params={
            "q": "(page.domain:*.br OR page.domain:*.us OR page.domain:*.uy OR page.domain:*.cl OR page.domain:*.pt OR page.domain:*.co) AND (domain:*bsc-dataseed.binance.org OR domain:*bsc-dataseed1.binance.org) AND filename:*wp-content*",
            "size": 10000
            }
        )
    ...
    @classmethod
    def wallets(cls, smart_contracts: list, chain_id: int, api_token: str) -> list:
        """_summary_
